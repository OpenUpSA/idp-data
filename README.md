[![codecov](https://codecov.io/gh/OpenUpSA/idp_data/branch/master/graph/badge.svg)](https://codecov.io/gh/OpenUpSA/idp_data/)
...
- [ ] Create a repository on [GitHub](https://github.com/OpenUpSA) and add as a remote to this repository
  - e.g. `git remote add origin git@github.com:OpenUpSA/idp_data.git`
