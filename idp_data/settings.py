"""
Django settings for idp_data project.
...
PROJ_DIR = ROOT_DIR.path("idp_data")
...
INSTALLED_APPS = [
    ...
    "idp_data.idp_data.apps.IDPDataConfig",
...
WSGI_APPLICATION = "idp_data.wsgi.application"
